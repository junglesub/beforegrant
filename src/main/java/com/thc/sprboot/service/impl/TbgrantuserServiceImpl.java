...
public class TbgrantuserServiceImpl implements TbgrantuserService {
    ...
    public TbgrantuserDto.CreateResDto delete(DefaultDto.DeleteServDto param){
        TbgrantuserDto.UpdateServDto newParam = TbgrantuserDto.UpdateServDto.builder().id(param.getId()).deleted("Y").reqTbuserId(param.getReqTbuserId()).isAdmin(param.isAdmin()).build();
    ...
    public TbgrantuserDto.CreateResDto deletes(DefaultDto.DeletesServDto param){
        ...
        for(String each : param.getIds()){
            TbgrantuserDto.UpdateServDto newParam = TbgrantuserDto.UpdateServDto.builder().id(each).deleted("Y").reqTbuserId(param.getReqTbuserId()).isAdmin(param.isAdmin()).build();
