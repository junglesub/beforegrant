...
@Tag(name = "0-2. 권한상세 API 안내",
        description = "권한상세 관련 기능 정의한 RestController.")
@RequestMapping("/api/tbgrantpart")
@RestController
public class TbgrantpartRestController {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    private final String tbgrantCate = "tbgrantpart";
    ...
    @Operation(summary = "권한상세 수정",
            description = "권한상세 수정 컨트롤러 <br />"
    ...
    @Operation(summary = "권한상세 삭제",
            description = "권한상세 삭제 컨트롤러 <br />"
    ...
    @Operation(summary = "권한상세 여러개 삭제",
            description = "권한상세 여러개 삭제 컨트롤러 <br />"
                    + "@param TbgrantpartDto.DeleteReqDto <br />"
                    + "@return HttpStatus.OK(200) ResponseEntity\\<TbgrantpartDto.CreateResDto\\> <br />"
                    + "@exception 필수 파라미터 누락하였을 때 등 <br />"
    )
    ...
    @Operation(summary = "권한상세 상세 조회",
            description = "권한상세 상세 조회 컨트롤러 <br />"
    ...
    @Operation(summary = "권한상세 목록 전체 조회",
            description = "권한상세 목록 전체 조회 컨트롤러 <br />"
    ...
    @Operation(summary = "권한상세 목록 페이지 조회",
            description = "권한상세 목록 페이지 조회 컨트롤러 <br />"
    ...
    @Operation(summary = "권한상세 목록 스크롤 조회",
            description = "권한상세 목록 스크롤 조회 컨트롤러 <br />"
