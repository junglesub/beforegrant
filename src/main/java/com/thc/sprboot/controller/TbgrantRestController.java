...
@Tag(name = "0-0. 권한 API 안내",
        description = "권한 관련 기능 정의한 RestController.")
...
public class TbgrantRestController {
    ...
    @Operation(summary = "권한 여러개 삭제",
            description = "권한 여러개 삭제 컨트롤러 <br />"
                    + "@param TbgrantDto.DeleteReqDto <br />"
                    + "@return HttpStatus.OK(200) ResponseEntity\\<TbgrantDto.CreateResDto\\> <br />"
                    + "@exception 필수 파라미터 누락하였을 때 등 <br />"
    )
    ...
    @Operation(summary = "권한 목록 전체 조회",
            description = "권한 목록 전체 조회 컨트롤러 <br />"
    ...
    @Operation(summary = "권한 목록 페이지 조회",
            description = "권한 목록 페이지 조회 컨트롤러 <br />"
    ...
    @Operation(summary = "권한 목록 스크롤 조회",
            description = "권한 목록 스크롤 조회 컨트롤러 <br />"
